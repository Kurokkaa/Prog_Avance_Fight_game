...
#define constante_h
    ...
    #define NB_COMBOS 1
    #define RANDOM_SPAWN_CHANCE 20
    #define MAX_LIFE 100
    #define MAX_SPECIAL 300

    enum game_state{combat, main_menu, pause, options, selection_perso, selection_map};

    enum character_state{idle, walk, jump, crouch, fall, backwards, flight, flight_control, fall_control, landing, knockback, lpunch , kickstate,hpunch,stun};
